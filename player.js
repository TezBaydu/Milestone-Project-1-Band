// Source: Ilker Yilmaz - https://github.com/kuantal/Multiple-circular-player#licence
...
(function ($) {
    ...
    var _ = {
        ...
        init: function (options) {
            ...
            var template = ['<svg viewBox="0 0 100 100" id="playable" version="1.1" xmlns="http://www.w3.org/2000/svg" width="30" height="30" data-play="playable" class="not-started playable">',
                '<g class="shape">',
                '<circle class="progress-track" cx="50" cy="50" r="47.45" stroke="#ec3135" stroke-opacity="0.25" stroke-linecap="round" fill="none" stroke-width="5"/>',
                ...
                '<polygon points="40,30 75,50 40,70" fill="#009EF8" stroke-width="0"></polygon>',
                '</g>',
